...
internal nonisolated enum UntranslatedL10n {
  ...
  /// %1$d members · %2$d verified
  internal static func screenRoomHeaderMembersVerified(_ p1: Int, _ p2: Int) -> String {
    return UntranslatedL10n.tr("Untranslated", "screen_room_header_members_verified", p1, p2)
  }
  /// %1$d of %2$d verified
